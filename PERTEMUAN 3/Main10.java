    ...
    public static void main(String[] args) {
        ...
        switch (menu) {
            case 1:
                ...
                int jmlK = sc.nextInt();
                Kerucut10[] listK = new Kerucut10[jmlK];

                for (int i = 0; i < jmlK; i++) { // looping untuk menerima inputan
                    listK[i] = new Kerucut10();
            ...
            case 3:
                ...
                int jmlL = sc.nextInt();
                LimasSegiEmpat10[] listL = new LimasSegiEmpat10[jmlL];
                ...
                for (int i = 0; i < jmlL; i++) { // looping untuk menerima inputan
                    ...
                    listL[i] = new LimasSegiEmpat10(panjangSisiAlas, tinggi);
