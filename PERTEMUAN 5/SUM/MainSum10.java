...
public class MainSum10 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < perusahaan; i++) {
            Sum10 sm = new Sum10(elm); // Membuat objek sum27 untuk setiap perusahaan
            for (int j = 0; j < elm; j++) {
            ...
            System.out.println(
                    "Total keuntungan perusahaan selama " + elm + " bulan adalah " + sm.totalBF(sm.keuntungan));
            System.out.println("Algoritma Divide Conquer");
            System.out.println("Total keuntungan perusahaan selama " + elm + " bulan adalah "
